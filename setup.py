...
setup(name='bloodhound',
      ...
      license='MIT',
      install_requires=['dnspython', 'impacket @ git+https://github.com/dadevel/impacket@latest', 'ldap3 @ git+https://github.com/dadevel/ldap3@latest', 'pyasn1>=0.4', 'future', 'pycryptodome'],
      classifiers=[
